            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-2 text-gray-900 dark:text-gray-100">
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                        <div
                            class="bg-white dark:bg-gray-900 p-8 rounded-2xl shadow-lg border border-gray-100 dark:border-gray-700 p-2">
                            ...
                            <div class="space-y-4 text-lg">
                                <div class="flex items-center">
                                    ...
                                    <span id="license_plate"
                                        class="px-3 py-1 rounded bg-gray-100 dark:bg-gray-800 text-gray-900 dark:text-gray-100 font-mono text-xl tracking-widest">
                                        {{ $vehicle->license_plate ?? '' }}
                                    </span>
                                </div>
                                <div class="flex items-center">
                                    <span class="w-40 font-semibold text-gray-700 dark:text-gray-300">Loại xe:</span>
                                    <span id="vehicle_type"
                                        class="px-3 py-1 rounded bg-gray-100 dark:bg-gray-800 text-gray-900 dark:text-gray-100">
                                        {{ $vehicle->vehicle_type ?? '' }}
                                    </span>
                                </div>
                                <div class="flex items-center">
                                    <span class="w-40 font-semibold text-gray-700 dark:text-gray-300">Thời gian
                                        vào:</span>
                                    <span id="time"
                                        class="px-3 py-1 rounded bg-gray-100 dark:bg-gray-800 text-gray-900 dark:text-gray-100">
                                ...
                                <div class="flex items-center">
                                    ...
                                    <span class="text-red-600 font-bold text-2xl" id="price">
                                        {{ isset($vehicle) && $vehicle->price ? number_format($vehicle->price) . ' VNĐ'
                                        : '0 VNĐ' }}
                                    </span>
                                </div>
                            </div>
                        ...
                        <div
                            class="bg-white dark:bg-gray-900 p-8 rounded-2xl shadow-lg border border-gray-100 dark:border-gray-700 flex flex-col items-center p-2">
                            ...
                            <div id="img_container" class="w-full flex justify-center items-center min-h-[250px]">
                                ...
                                <img id="vehicle_img" src="{{ $vehicle->img }}" alt="Ảnh xe"
                                    class="rounded-xl border border-gray-300 shadow-md max-h-72 object-contain">
                                @else
